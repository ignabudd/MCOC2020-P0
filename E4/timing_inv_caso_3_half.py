# -*- coding: utf-8 -*-
"""
Created on Wed Aug 12 00:20:39 2020
...
def plotting(Ncorridas): 
    ...
    data = sp.loadtxt("caso_3_half0.txt")     #cambiar
    ...
    for i in range (1, Ncorridas):
        data = sp.loadtxt(f"caso_3_half{i}.txt")  #cambiar
    ...
    plt.title("Rendimiento A Inv - Caso 3 - Half")     #cambiar
    plt.grid(True)
    plt.xticks(xtcks, [])
